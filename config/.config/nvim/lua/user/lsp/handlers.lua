...
local function lsp_keymaps(bufnr)
  ...
  vim.api.nvim_buf_set_keymap(bufnr, "i", "<C-b>", "<cmd>lua vim.lsp.buf.code_action()<CR>", opts)
  vim.api.nvim_buf_set_keymap(bufnr, "n", "<C-b>", "<cmd>lua vim.diagnostic.open_float()<CR>", opts)
